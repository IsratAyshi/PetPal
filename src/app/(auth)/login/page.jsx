        ...
        <div className='bg-[#ffdacb] dark:bg-[#1E1A17] flex justify-between'>
            ...
            <div className="max-w-7xl py-10 md:p-20 flex flex-col justify-center bg-white dark:bg-[#6d5d5d]/40 my-5 md:rounded-l-4xl flex-1">
                ...
                <div className="my-6">
                    ...
                    <p className="text-gray-500 text-center mt-1">Welcome back to your adoption journey</p>
                </div>
                ...
                <Card className='shadow-none max-w-md mx-auto mb-4 px-6 py-8 '>
                    ...
                    <div>
                        <p className="text-center mt-1 text-sm text-gray-500">Don't have an account? <a href="/signup" className="text-[#ff7f50] dark:text-[#FFAA80] hover:underline">Sign Up</a></p>
                    </div>
                </Card>
            </div>
        </div>

    ...
    return (
        <section className="py-24 px-6 lg:px-12 max-w-7xl mx-auto ">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                {/* Card 1 */}
                <FadeUp delay={0.1}>
                    <div className="p-8 bg-[#FFD9C8]/40 rounded-3xl flex flex-col items-center text-center transition-all duration-300 hover:scale-[1.03] hover:-translate-y-4 shadow-sm hover:shadow-lg">
                ...
                {/* Card 2 */}
                <FadeUp delay={0.2}>
                    <div className="p-8 bg-[#FFE7D6]/40 rounded-3xl flex flex-col items-center text-center transition-all duration-300 hover:scale-[1.03] hover:-translate-y-4 shadow-sm hover:shadow-lg">
                ...
                {/* Card 3 */}
                <FadeUp delay={0.3}>
                    <div className="p-8 bg-[#F0CAA5]/40 rounded-3xl flex flex-col items-center text-center transition-all duration-300 hover:scale-[1.03] hover:-translate-y-4 shadow-sm hover:shadow-lg">
